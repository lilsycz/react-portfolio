...
const projects = [
  ...
  },
  {
    ...
    whatItDoes: "A real-time interactive installation that uses your device's camera to track hand gestures. When you open your hand, particles bloom into a flower shape with glowing effects; when you close your fist, they contract. Supports up to 4 hands simultaneously, with multiple visual modes (Flower trails, Nebula bloom, Minimal particles).",
    whatYouLearned: 'Working with Three.js for 3D particle systems and WebGL rendering; Integrating MediaPipe for real-time hand landmark tracking; Translating gesture data into visual animation; Post-processing effects like bloom with UnrealBloomPass; Fallback logic for when camera is unavailable.',
